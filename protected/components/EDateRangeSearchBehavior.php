<?php
/**
 * To be able to add date range searching functionality 
 * to your advanced search forms without having to add public attributes, 
 * 'safe' rules, and chunky search conditions for each date attribute.
 *
