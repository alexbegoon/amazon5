...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row form-group">
		<?php echo $form->label($model,'shipping_company_id',array('class'=>'control-label')); ?>
		<?php echo $form->textField($model,'shipping_company_id',array('class'=>'form-control')); ?>
	</div>

	<div class="row form-group">
		<?php echo $form->label($model,'shipping_type_id',array('class'=>'control-label')); ?>
		<?php echo $form->textField($model,'shipping_type_id',array('class'=>'form-control')); ?>
	</div>
