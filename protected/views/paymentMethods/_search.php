...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row form-group">
		<?php echo $form->label($model,'handler_component',array('class'=>'control-label')); ?>
		<?php echo $form->textField($model,'handler_component',array('size'=>13,'maxlength'=>13,'class'=>'form-control')); ?>
	</div>

	<div class="row form-group">
		<?php echo $form->label($model,'parameters',array('class'=>'control-label')); ?>
		<?php echo $form->textField($model,'parameters',array('class'=>'form-control')); ?>
	</div>
