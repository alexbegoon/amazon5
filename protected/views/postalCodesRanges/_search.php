...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row form-group">
		<?php echo $form->label($model,'range_name',array('class'=>'control-label')); ?>
	...
	<div class="row form-group">
		<?php echo $form->label($model,'postal_code_from',array('class'=>'control-label')); ?>
		<?php echo $form->textField($model,'postal_code_from',array('class'=>'form-control')); ?>
	</div>

	<div class="row form-group">
		<?php echo $form->label($model,'postal_code_to',array('class'=>'control-label')); ?>
