...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('postal_code_from')); ?>:</b>
	<?php echo CHtml::encode($data->postal_code_from); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('postal_code_to')); ?>:</b>
	<?php echo CHtml::encode($data->postal_code_to); ?>
	<br />
