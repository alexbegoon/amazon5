...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row form-group">
		<?php echo $form->labelEx($model,'image_archive',array('class'=>'control-label')); ?>
		<?php echo CHtml::activeFileField($model, 'image_archive'); ?>
		<?php echo $form->error($model,'image_archive',array('class'=>'label label-danger')); ?>
	</div>
