...
$this->menu=array(
	...
	array('label'=>Yii::t('common','Delete') .' '. Yii::t('common','Languages'), 'url'=>'#', 'linkOptions'=>array('submit'=>array('delete','id'=>$model->lang_code),'confirm'=>Yii::t('zii','Are you sure you want to delete this item?'))),
