...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row form-group">
		<?php echo $form->label($model,'shipping_type_name',array('class'=>'control-label')); ?>
		<?php echo $form->textField($model,'shipping_type_name',array('size'=>60,'maxlength'=>255,'class'=>'form-control')); ?>
	</div>

	<div class="row form-group">
		<?php echo $form->label($model,'shipping_type_desc',array('class'=>'control-label')); ?>
		<?php echo $form->textField($model,'shipping_type_desc',array('size'=>60,'maxlength'=>255,'class'=>'form-control')); ?>
	</div>
