...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('shipping_type_name')); ?>:</b>
	<?php echo CHtml::encode($data->shipping_type_name); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('shipping_type_desc')); ?>:</b>
	<?php echo CHtml::encode($data->shipping_type_desc); ?>
	<br />
