...
class ServicesProvidersInvoices extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, provider_type, vat_type, file_name, file_mime_type, file_extension, file_size, invoice_number, provider_id, paid, net_cost, currency_id, paid, paid_date, invoice_date, due_date, created_on, created_by, modified_on, modified_by, locked_on, locked_by', 'safe', 'on'=>'search'),
		);
	}
