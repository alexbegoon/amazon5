...
class ProviderProductsHistories extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('provider_id, product_id', 'required'),
			array('provider_id, quantity_in_stock, currency', 'numerical', 'integerOnly'=>true),
			...
			array('id, provider_id, product_id, provider_price, quantity_in_stock, currency, created_on', 'safe', 'on'=>'search'),
		);
	}
