...
class ContinentsController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['Continents'];
			if($model->save())
	...
	public function actionAdmin()
	{
		...
		if(isset($_GET['Continents']))
			$model->attributes=$_GET['Continents'];
	 ...
	 * @param Continents $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='continents-form')
		{
