...
class ProviderInvoicesController extends Controller
{
	...
	{
		$model=new ProviderInvoices;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['ProviderInvoices']))
		{
			$model->attributes=$_POST['ProviderInvoices'];
			if($model->save())
	...
	{
		$model=new ProviderInvoices('search');
	 ...
	 * @return ProviderInvoices the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=ProviderInvoices::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='provider-invoices-form')
		{
