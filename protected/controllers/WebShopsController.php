...
class WebShopsController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['WebShops'];
			if($model->save())
	...
	{
		$dataProvider=new CActiveDataProvider('WebShops');
	...
	{
		$model=new WebShops('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['WebShops']))
			$model->attributes=$_GET['WebShops'];
	 ...
	 * @return WebShops the loaded model
	 ...
	 * @param WebShops $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='web-shops-form')
		{
