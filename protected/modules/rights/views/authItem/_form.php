...
<?php $form=$this->beginWidget('CActiveForm'); ?>
	...
	<div class="row form-group">
		...
		<p class="hint label label-primary"><?php echo Rights::t('core', 'Do not change the name unless you know what you are doing.'); ?></p>
	</div>
	...
	<div class="row form-group">
		...
		<p class="hint label label-primary"><?php echo Rights::t('core', 'A descriptive name for this item.'); ?></p>
	</div>
	...
	<?php if( Rights::module()->enableBizRule===true ): ?>
		...
		<div class="row form-group">
			...
			<p class="hint label label-primary"><?php echo Rights::t('core', 'Code that will be executed when performing access checking.'); ?></p>
		</div>
	...
	<?php if( Rights::module()->enableBizRule===true && Rights::module()->enableBizRuleData ): ?>
		...
		<div class="row form-group">
			...
			<p class="hint label label-primary"><?php echo Rights::t('core', 'Additional data available when executing the business rule.'); ?></p>
		</div>
